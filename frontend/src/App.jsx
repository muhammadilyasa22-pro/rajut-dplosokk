...
import BeliLangsungPage from "./views/pages/BeliLangsungPage";
...
import KategoriPage from "./views/pages/admin/KategoriPage";
import LaporanPage from "./views/pages/admin/LaporanPage";
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route element={<PublicLayout />}>
            ...
            <Route path="/keranjang" element={<RequireAuth role="pembeli"><KeranjangPage /></RequireAuth>} />
            <Route path="/beli-langsung" element={<RequireAuth role="pembeli"><BeliLangsungPage /></RequireAuth>} />
