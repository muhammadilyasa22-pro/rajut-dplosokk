  ...
  return (
    <section className="section container">
      ...
      <div className="detail-grid">
        ...
        <div className="detail-copy"><span className="tag">{product.kategori}</span><h1>{product.nama_produk}</h1><div className="price">Rp {Number(product.harga || 0).toLocaleString("id-ID")}</div><p>{product.deskripsi}</p>
