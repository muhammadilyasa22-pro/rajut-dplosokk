...
async function request(path, { method = "GET", body, params, signal } = {}) {
  ...
  const token = localStorage.getItem("dplosokk_token") || localStorage.getItem("token");
...
export const login = (uname, passwd) => request("/auth/login", { method: "POST", body: { uname, passwd } });
export const register = (data) => request("/auth/register", { method: "POST", body: data });
export const getProduk = (params) => request("/produk", { params });
export const getProdukById = (id) => request(`/produk/${id}`);
...
export const getPembelian = (params) => request("/pembelian", { params });
export const createPembelian = (data) => request("/pembelian", { method: "POST", body: data });
export const updatePembelianStatus = (id, status) => request(`/pembelian/${id}`, { method: "PUT", body: { status } });
export const getArtikel = (params) => request("/artikel", { params });
